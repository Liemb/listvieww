...
/**
 * On this Activity the user needs to choose one country (from his chosen continent) out of 7.
 * After choosing a country the user will see its Capital city and the population of this country.
 */
...
public class Main2Activity extends AppCompatActivity implements AdapterView.OnItemClickListener  {
     ...
     * the first one contains the contries in each continent, each sell is a different continent.
     * The first cell of the second array contains the Capital cities and the second contains the populations, in the same order of the countries.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * getting the user's continent choice from MainActivity.
         */
        Intent si=getIntent();
        ...
        /**
         * connecting the ListView to the String array that the user picked.
         */
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        /**
         * showing as TextView the capital city and the population of the chosen country.
         */
